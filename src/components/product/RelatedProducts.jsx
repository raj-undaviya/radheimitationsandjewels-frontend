            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                ...
                {related.map((item) => (
                    ...
                    >
                        ...
                        {/* CARD */}
                        <div className="bg-[#111] border border-[#1f1f1f] rounded-xl p-3 transition hover:border-orange-500/50">

                            {/* IMAGE BOX  */}
                            <div className="relative w-full aspect-square bg-[#0b0b0b] rounded-lg overflow-hidden">
                        ...
                        <div className="mt-3 px-1">
                            ...
                            <h3 className="text-xs sm:text-sm text-gray-300 line-clamp-1">
                                {item.name}
                            </h3>

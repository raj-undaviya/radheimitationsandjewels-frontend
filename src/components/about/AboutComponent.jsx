      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="relative h-[90vh] flex items-center justify-center text-center text-white overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl px-6">
            ...
            <p className="text-gray-300 mt-4 text-sm md:text-base">
              For four decades, we have defined the intersection of timeless
              heritage and digital-era precision, crafting artifacts that
              whisper stories of royalty.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-7 mb-5">
                Born in the heart of artisanal traditions, Radhe Imitations &
                Jewels began with a singular vision: to make the opulence of the
                royal vaults accessible to the modern connoisseur.
              </p>

              <p className="text-gray-400 text-sm leading-7 mb-8">
                What started as a small atelier of master craftsmen has evolved
                into a globally recognized hallmark of imitation jewelry that
                rivals the finest natural gemstones in clarity, weight, and
                soul.
              </p>
            </div>
          </div>
        ...
        <section className="bg-[#0a0a0a] text-white px-6 md:px-20 ">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative border border-[#1a1a1a] h-[320px] md:h-[360px] overflow-hidden group">
              ...
              <div className="absolute bottom-6 left-6">
                ...
                <p className="text-gray-300 text-sm mt-2 max-w-sm">
                  Every piece begins as a hand-drawn blueprint, merging
                  classical motifs.
                </p>
              </div>
            </div>
            ...
            <div className="group border border-[#1a1a1a] p-8 bg-black hover:border-orange-400/40 transition flex flex-col justify-center">
              ...
              <p className="text-gray-400 text-sm leading-6">
                Our signature multi-stage polishing ensures a mirror-like finish
                that captures light.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="group border border-[#1a1a1a] p-8 bg-black hover:border-orange-400/40 transition flex flex-col justify-center">
              ...
              <p className="text-gray-400 text-sm leading-6">
                Every creation is assigned a unique serial number and stored
                securely.
              </p>
            </div>
            ...
            <div className="relative md:col-span-2 border border-[#1a1a1a] h-[320px] md:h-[360px] overflow-hidden group">
              ...
              <div className="absolute bottom-6 left-6">
                ...
                <p className="text-gray-300 text-sm mt-2 max-w-sm">
                  Using advanced alloy techniques, we achieve perfect balance
                  and durability.
                </p>
              </div>
            </div>
        ...
        <section className="bg-black px-6 md:px-20 py-24">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {/* ITEM */}
            <div className="group">
              <h3 className="text-4xl md:text-6xl font-semibold text-orange-400 drop-shadow-[0_0_10px_rgba(249,115,22,0.5)] group-hover:scale-110 transition duration-300">
                40+
              </h3>
            ...
            {/* ITEM */}
            <div className="group">
              <h3 className="text-4xl md:text-6xl font-semibold text-orange-400 drop-shadow-[0_0_10px_rgba(249,115,22,0.5)] group-hover:scale-110transition duration-300">
                100%
              </h3>

              <p
                className="text-gray-500 
              text-xs tracking-widest mt-3 uppercase"
              >
                Artisanal Sourcing
              </p>
